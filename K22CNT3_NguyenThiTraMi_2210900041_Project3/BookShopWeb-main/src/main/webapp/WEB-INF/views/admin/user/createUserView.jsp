...
<body>
<c:import url="/WEB-INF/views/_headerAdmin.jsp"/>
...
<section class="section-content">
  <div class="container">
    ...
    <main class="row mb-5">
      <form class="col-lg-6" method="POST" action="${pageContext.request.contextPath}/admin/userManager/create">
...
<c:import url="/WEB-INF/views/_footerAdmin.jsp"/>
</body>
